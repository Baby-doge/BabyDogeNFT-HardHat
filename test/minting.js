...
it("Should be able to reserve doges", async function () {
   await babyDogeNft.reserveDoges("1");
   console.log("balanceOF" , await babyDogeNft.balanceOf(owner.address))
   console.log("Owner address", owner.address);
   console.log("ownerOf", await babyDogeNft.ownerOf("0"))
   expect(await babyDogeNft.totalSupply()).to.equal(1);
});
...
// let owner = await babyDogeNft.ownerOf("104");
// console.log()
...
//     let totalsupply = await babyDogeNft.totalSupply()
//     expect(totalsupply).to.equal("105")
//     });
